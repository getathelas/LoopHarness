...
flowchart LR
    ...
    Harness --> Providers["Model provider<br/>OpenAI, Anthropic, Amazon Bedrock,<br/>Fireworks, Together AI, or Apple on-device"]
...
4. **Choose a model route.** Online requests go directly to the selected
   OpenAI, Anthropic, Amazon Bedrock, Fireworks, or Together AI client. Apple Foundation Models are used
