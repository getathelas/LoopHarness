...
"""
            ...
            "function": [
                ...
                "parameters": [
                    ...
                    "properties": [
                        "name": [
                            "type": "string",
                            "description": "Key identifier. Aliases accepted: openai, together, deepgram, elevenlabs, exa, cursor, obsidian_api, obsidian_base_url, obsidian_vault_name."
                        ],
                        "value": [
                            "type": "string",
    ...
    private func setApiKey(name: String,
        ...
        guard let key = Self.resolveKey(from: name) else {
            completion(Self.functionMessage(name: toolName, payload: [
                "error": "unknown_key",
                "name": name,
                "hint": "Aliases accepted: openai, together, deepgram, elevenlabs, exa, cursor, obsidian_api, obsidian_base_url, obsidian_vault_name."
            ]))
            return
        }
    ...
    private static func resolveKey(from raw: String) -> KeyStore.Key? {
        ...
        case "fireworks":                                     return .fireworks
        case "together", "together_ai", "together ai":      return .together
        case "deepgram":                                      return .deepgram
