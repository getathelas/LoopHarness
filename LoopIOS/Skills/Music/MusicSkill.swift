...
- find_music: search the Apple Music catalog and the user's personal library playlists. Returns `songs`, `albums`, `playlists` (catalog) and `library_playlists` (user's own). Pass `query`, optional `instrumental_only` (default false), optional `limit` (default 8).
...
"""
    ...
    static let tools: [[String: Any]] = [
        [
            ...
            "function": [
                "name": "find_music",
                "description": "Search Apple Music's catalog for songs, albums, and playlists, and the user's personal library playlists. Returns catalog results plus a `library_playlists` array with playlists saved in the user's own library. All returned ids can be passed to play_music.",
                "parameters": [
                    "type": "object",
                    "properties": [
                        "query": [
